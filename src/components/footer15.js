              ...
              <div className="footer15-container2">
                ...
                <div className="footer15-social-links">
                  <a
                    ...
                    className="footer15-link"
                  >
                    <svg
                      viewBox="0 0 877.7142857142857 1024"
                      className="footer15-icon thq-icon-small"
                    >
                  ...
                  >
                    <svg
                      viewBox="0 0 877.7142857142857 1024"
                      className="footer15-icon02 thq-icon-small"
                    >
                  ...
                  >
                    <svg
                      ...
                      className="footer15-icon04 thq-icon-small"
                    >
                  ...
                  >
                    <svg
                      viewBox="0 0 877.7142857142857 1024"
                      className="footer15-icon06 thq-icon-small"
                    >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="footer15-link4"
                  >
                    <svg
                      viewBox="0 0 1024 1024"
                      className="footer15-icon08 thq-icon-small"
                    >
...
Footer15.defaultProps = {
  ...
  copyright: '© 2023 Football Club. All Rights Reserved.',
  logoAlt: 'Football Club Logo',
  content2:
    'Stay connected with us on social media for the latest updates and news.',
  action1: 'Contact Us',
  content1: 'Join our mailing list for exclusive offers and updates.',
}
